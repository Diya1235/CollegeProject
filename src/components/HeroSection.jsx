      ...
      <div className='relative z-10 text-center px-4'>
        <div className='flex flex-col gap-5 my-10'>
          <span className='mx-auto px-4 py-2 rounded-full bg-blue-500 text-slate-100 font-bold text-sm sm:text-base'>
            Your IT career, our Solutions: Achieve Excellence together
          </span>
          
          <h1 className='text-3xl font-bold mt-10 sm:text-4xl md:text-5xl'>
            <span className={`text-blue-500 ${animate ? 'slide-in-out-fade' : ''}`}>Browse</span>, Create & <br />Get your problems
            <span className='text-blue-500'> solved</span>
          </h1>
          ...
          <div className='flex flex-col-reverse sm:flex-row items-center gap-6 mt-10 py-5'>
            ...
            <div className='flex flex-col justify-left text-left w-full sm:w-1/2'>
              ...
              <Link to="/findprojects"><Button className="bg-blue-500 text-slate-100 rounded-md w-full sm:w-1/2 mt-5 hover:bg-blue-800">Find Now</Button></Link>
            </div>
          </div>
